        ...
        <nav class="sidebar close">
            ...
            <div class="menu-bar">
                <div class="menu">
                    <div>
                        <?php 
                            foreach($usu_datos as $item) {?>
                                <img class="circular--portrait" src="assets/img/IMG_Profile/<?php echo $item['Foto']?>"
                                <br>
                                
                                <span class="text nav-text"> Bienvenido <?php echo $item['Nombre']?></span>
                                <span class="text nav-text"><?php echo $item['Email']?></span>
